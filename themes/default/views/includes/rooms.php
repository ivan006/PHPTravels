        ...
        <div class="rooms-update">
            <form action="" method="GET">
                ...
                <div class="col-md-2 col-lg-2 col-sm-2 row">
                    <?php if(!empty($rooms)){ ?>
                    <h5 style="margin-top: 34px;" class="text-center size16 row"><strong><i class="icon_set_1_icon-83"></i><?php echo trans('0122');?></strong> <?php echo $modulelib->stay; ?> </h5>
                    <?php } ?>
                </div>
            </form>
                    ...
                    <div class="labelleft2 rtl_title_home go-text-right RTL">
                        <h4 class="mtb0 RTL go-text-right">
                            ...
                            <span class="pull-right">
                                ...
                                <span class="size11 grey"><?php echo trans('070');?> <?php echo $modulelib->stay; ?> <?php echo trans('0122');?></strong> </span>
                                <div class="clearfix"></div>
                                <?php } ?>
                            </span>
                        </h4>
