<style>
  .body { margin-top:-25px; width: 100%; height: 100%; background: rgb(90,113,155); background: -moz-linear-gradient(45deg, rgba(90,113,155,1) 0%, rgba(83,109,155,1) 20%, rgba(57,92,160,1) 44%, rgba(1,37,114,1) 82%); background: -webkit-linear-gradient(45deg, rgba(90,113,155,1) 0%,rgba(83,109,155,1) 20%,rgba(57,92,160,1) 44%,rgba(1,37,114,1) 82%); background: linear-gradient(45deg, rgba(90,113,155,1) 0%,rgba(83,109,155,1) 20%,rgba(57,92,160,1) 44%,rgba(1,37,114,1) 82%); filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#5a719b', endColorstr='#012572',GradientType=1 ); }
  ...
  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3" style="margin-bottom:400px;margin-top100px">
    ...
    <form method="POST" action="" id="loginfrm" accept-charset="UTF-8" onsubmit="return false;">
      ...
      <div class="login-wrap">
        ...
        <div data-wow-duration="1s" data-wow-delay="1s" class="login-c1 wow fadeIn">
...
<script>
  ...
  $(".resultlogin").html("<div id='rotatingDiv'></div> <div style='margin-right:-25px' class='alert alert-info'><?php echo trans('0427');?></div>");
