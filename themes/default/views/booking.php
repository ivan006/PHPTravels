    ...
    <div class="loadinvoice">
      ...
      <div class="col-md-4 go-left">
        <div class="pagecontainer2 paymentbox">
          <div class="filtertip">
            <div class="padding20">
              <h4 class="size24 text-center"><i class="icon_set_1_icon-87 go-right"></i><span><?php echo trans('0411');?></span> <span class="countprice"></span></h4>
            </div>
            <div class="clearfix"></div>
          </div>
            ...
            <img class="img-responsive" src="<?php echo $module->thumbnail;?>" alt="<?php echo $module->title;?>" />
              ...
              <div class="row">
                ...
                <div style="padding-top:0px;padding-bottom:15px">
                  <span class="right lred2 bold size30">  <strong><?php echo $room->currCode;?> <?php echo $room->currSymbol;?><span id="displaytotal"><?php echo $room->price;?></span></strong></span>
                  <div class="clearfix"></div>
                </div>
                <?php } ?>
