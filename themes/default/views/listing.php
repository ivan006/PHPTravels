...
<link rel="stylesheet" href="<?php echo $theme_url; ?>plugins/jslider/css/jslider.round.css" type="text/css">
 ...
 <div class="row listing-search">
  ...
  <div class="col-md-1 col-sm-2 col-xs-4 summary go-right">
   ...
   <div class="col-md-1 col-sm-2 col-xs-4 sideline hidden-md go-right">
   ...
   <div data-toggle="modal" data-target="#modify" style="margin-top:11px" class="go-right col-md-2 col-sm-2 col-lg-1 col-xs-4 btn-action row">
    <?php echo trans('0106');?>
   </div>
 ...
 <style>
 .summary  { border-right: solid 2px #f4f4f4; color: #23527c; background: #fafafa; padding: 15px; float: left; font-size: 14px; }
 ...
 .captext  { display: block; font-size: 16px; font-weight: 400; color: #23527c; line-height: 1.2em; text-transform: capitalize; }
...
<div style="margin-top:150px" class="modal fade" id="modify" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" ng-controller="autoSuggestCtrl">
        ...
        <div class="wow fadeInUp col-md-8 offset-0">
          <div class="itemlabel3">
            <div class="labelright go-left" style="min-width:105px;margin-left:5px">
              ...
              <?php } } ?>
              <a href="<?php echo $item->slug;?>">
              <button type="submit" class="btn btn-action btn-block"><?php echo trans('0177');?></button>
              </a>
            </div>
