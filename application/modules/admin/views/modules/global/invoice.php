...
<div class="modal-dialog modal-lg" style="z-index: 10">
  <div class="modal-content" style="z-index: 1025">
    <div style="background-color: rgba(54, 58, 64, 0.84); padding: 10px; margin-bottom: 15px;">
    ...
    <hr>
    <?php } } ?>
    <div style="padding: 45px;" class="col-md-6">
      <img  src="<?php echo PT_GLOBAL_IMAGES_FOLDER.$app_settings[0]->header_logo_img;?>" class="logo"/>
    </div>
    <div style="padding-right: 35px; padding-top: 25px; margin-bottom: 25px;" class="col-md-6">
    ...
    <div style="min-height: 20px; padding: 19px; margin-bottom: 10px; background-color: rgba(179, 217, 238, 0.24); border-bottom: 1px solid #b3d9ee; border-top: 1px solid #b3d9ee; -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .05); box-shadow: inset 0 1px 1px rgba(0, 0, 0, .05);" class="">
      <div class="col-md-6">
        <div class="hidden-xs">
        ...
        <div style="font-size: 50px;text-transform:uppercase"><?php echo trans('076');?></div>
